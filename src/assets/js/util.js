...
var KTUtil = function () {
    ...
    return {
        ...
        actualCss: function (el, prop, cache) {
            ...
            if (!el.getAttribute('app-hidden-' + prop) || cache === false) {
                var value;
                ...
                // store it in cache
                el.setAttribute('app-hidden-' + prop, value);

                return parseFloat(value);
            } else {
                // store it in cache
                return parseFloat(el.getAttribute('app-hidden-' + prop));
            }
        },
        ...
        scrollInit: function (element, options) {
            ...
            function init() {
                ...
                if (ps) {
                    ...
                    KTUtil.addClass(element, 'app-scroll');
...
// CSS3 Transitions only after page load(.app-page-loading class added to body tag and remove with JS on page load)
window.onload = function () {
    KTUtil.removeClass(KTUtil.get('body'), 'app-page--loading');
}
